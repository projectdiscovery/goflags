...
func main() {
	...
	flagSet.CreateGroup("info", "Info",
		...
		flagSet.StringSliceVarP(&testOptions.Email, "email", "e", []string{}, "email of the user", goflags.CommaSeparatedStringSliceOptions),
	)
	flagSet.CreateGroup("additional", "Additional",
		flagSet.StringVarP(&testOptions.Phone, "phone", "ph", "", "phone of the user"),
		flagSet.StringSliceVarP(&testOptions.Address, "address", "add", []string{}, "address of the user", goflags.StringSliceOptions),
	)
